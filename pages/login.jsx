  ...
  return (
    <div>
      <div class="px-6 h-full text-gray-800">
        <div
          class="flex xl:justify-center lg:justify-between 
      justify-center items-center flex-wrap h-full g-6"
        >
          <div
            class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div class="flex flex-row items-center justify-center lg:justify-start">
                ...
                <button
                  ...
                  class="inline-block p-3 bg-blue-600 text-white font-medium text-xs
               leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 
              ...
              <div
                class="flex items-center my-4 before:flex-1 before:border-t 
